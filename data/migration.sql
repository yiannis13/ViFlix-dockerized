...
CREATE TABLE [Customers] (
    ...
    CONSTRAINT [FK_Customers_MembershipTypes_MembershipTypeId] FOREIGN KEY ([MembershipTypeId]) REFERENCES [MembershipTypes] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [Rentals] (
    ...
    [DateRented] datetime2 NOT NULL,
    [DateReturned] datetime2 NULL,
    [DateToBeReturned] datetime2 NOT NULL,
    ...
    CONSTRAINT [FK_Rentals_Movies_MovieId] FOREIGN KEY ([MovieId]) REFERENCES [Movies] ([Id]) ON DELETE CASCADE
);
...
VALUES (N'20180930122708_InitialModel', N'2.1.3-rtm-32065');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180930125034_PopulateMembershipTypes', N'2.1.3-rtm-32065');

GO

UPDATE dbo.MembershipTypes SET Name = 'Pay As You Go' where id=1
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180930125825_PopulateMembershipTypeNames', N'2.1.3-rtm-32065');
...
INSERT INTO Genre SELECT 1, 'Comedy'

GO

INSERT INTO Genre SELECT 2, 'Action'

GO

INSERT INTO Genre SELECT 3, 'Family'

GO

INSERT INTO Genre SELECT 4, 'Romance'

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180930131335_AddGenreTableAndPolulate', N'2.1.3-rtm-32065');
...
ALTER TABLE [Movies] ALTER COLUMN [Name] nvarchar(255) NOT NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180930133037_AddValidationToFields', N'2.1.3-rtm-32065');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20180930212045_SeedUserClaimAdmin', N'2.1.3-rtm-32065');
